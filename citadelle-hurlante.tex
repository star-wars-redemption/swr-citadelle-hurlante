...
\begin{document}
	...
	% 	\node[minimum width=180pt,minimum height=180pt, rotate=0] at (17,20){\includegraphics[width=180pt]{_img/pnjs/duinuogwuin-02.png}};
	% \end{tikzpicture}}
    % \begin{tikzpicture}[overlay]
	% 	\node[minimum width=180pt,minimum height=180pt, rotate=0] at (1,13){\includegraphics[width=180pt]{_img/pnjs/nightsister.png}};
	% \end{tikzpicture}}
	\end{titlepage}
	...
	\include{tex/scenars/DrH-01.Le-Prince-de-Dac}
	\include{tex/jokers}
